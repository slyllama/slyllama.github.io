...
/** @type {string} */
const CACHE_VERSION = '1763418371|3303196828';
/** @type {string} */
const CACHE_PREFIX = 'Tiny Test-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'tiny.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["tiny.html","tiny.js","tiny.offline.html","tiny.icon.png","tiny.apple-touch-icon.png","tiny.audio.worklet.js","tiny.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tiny.wasm","tiny.pck"];
